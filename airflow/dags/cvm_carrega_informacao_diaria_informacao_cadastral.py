...
def load_data_to_db():
    ...
    # debug pegando arquivos específicos
    ultimos_tres_arquivos = arquivos_no_diretorio_diaria[-3:]
    # arquivos_no_diretorio_diaria = [next(filter(lambda x: x.name == 'inf_diario_fi_202204.csv', arquivos_no_diretorio_diaria))]

    # salva arquivos a partir do arquivo inf_diario_fi_202312.csv
    # for arquivo in arquivos_no_diretorio_diaria:
    #     if arquivo.name == 'inf_diario_fi_202312.csv':
    #         arquivos_no_diretorio_diaria = arquivos_no_diretorio_diaria[arquivos_no_diretorio_diaria.index(arquivo):]
    #         break

    arquivos_no_diretorio_diaria = ultimos_tres_arquivos
