...
def create_tables():
    ...
    CREATE TABLE IF NOT EXISTS INFORMACAO_CADASTRAL (
        ...
        CUSTODIANTE VARCHAR(500),
        DENOM_SOCIAL VARCHAR(500),
        DIRETOR VARCHAR(500),
        DT_CANCEL DATE,
        DT_CONST DATE,
        DT_FIM_EXERC DATE,
        ...
        GESTOR VARCHAR(500),
        INF_TAXA_ADM VARCHAR(1000),
        INF_TAXA_PERFM VARCHAR(1000),
        INVEST_CEMPR_EXTER VARCHAR(1),
        PF_PJ_GESTOR CHAR(2),
        PUBLICO_ALVO VARCHAR(500),
        RENTAB_FUNDO VARCHAR(500),
        SIT VARCHAR(500),
        TAXA_ADM REAL,
        TAXA_PERFM REAL,
    ...
    CREATE TABLE IF NOT EXISTS REGISTRO_CLASSE (
        ...
        DATA_CONSTITUICAO DATE,
        DATA_INICIO DATE,
        TIPO_CLASSE VARCHAR(500),
        DENOMINACAO_SOCIAL VARCHAR(500),
        SITUACAO VARCHAR(500),
        CLASSIFICACAO VARCHAR(500),
        IDENTIFICADOR_DESEMPENHO VARCHAR(500),
        CLASSE_COTAS VARCHAR(1),
        CLASSIFICACAO_ANBIMA VARCHAR(500),
