    ...
    with engine.begin() as connection:
        ...
        query = text("""
            ...
            SELECT 
                ...
                denominacao_social,
                patrimonio_medio as vl_total,
                total_resgates,
                total_aportes,
                fluxo_liquido,
                CASE 
                    WHEN patrimonio_medio > 0 THEN 
                        (fluxo_liquido / patrimonio_medio) * 100
                    ELSE 0 
